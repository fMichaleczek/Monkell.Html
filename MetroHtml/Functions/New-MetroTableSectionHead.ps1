function New-MetroTableSectionHead {
...
[CmdletBinding()]
    ...
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('New-HtmlThead', [System.Management.Automation.CommandTypes]::Function)
