...
[CmdletBinding()]
    ...
    if ($Class.Count -gt 0) { $PSBoundParameters["ClassName"] = ($Class -join " ").Trim() } 
      $PSBoundParameters.ClassName =  [string[]]@($PSBoundParameters.ClassName, 'pagination')
 

      if ('PaginationStyle' -in $PSBoundParametersKeys) { 
            ...
            $null = $PSBoundParameters.Remove('PaginationStyle') 
      } 
