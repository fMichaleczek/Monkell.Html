function New-MetroToolbarButton {
...
[CmdletBinding()]
    ...
    if ($Class.Count -gt 0) { $PSBoundParameters["ClassName"] = ($Class -join " ").Trim() } 
      $PSBoundParameters.ClassName =  [string[]]@($PSBoundParameters.ClassName, 'toolbar-button')
    ...
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('New-MetroIconButton', [System.Management.Automation.CommandTypes]::Function)
