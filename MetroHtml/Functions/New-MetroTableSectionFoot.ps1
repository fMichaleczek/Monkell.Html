function New-MetroTableSectionFoot {
...
[CmdletBinding()]
    ...
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('New-HtmlTfoot', [System.Management.Automation.CommandTypes]::Function)
