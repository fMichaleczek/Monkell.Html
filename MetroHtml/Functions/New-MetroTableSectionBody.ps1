function New-MetroTableSectionBody {
...
[CmdletBinding()]
    ...
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('New-HtmlTbody', [System.Management.Automation.CommandTypes]::Function)
