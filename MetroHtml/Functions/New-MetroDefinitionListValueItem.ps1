function New-MetroDefinitionListValueItem {
...
[CmdletBinding()]
    ...
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('New-HtmlLi', [System.Management.Automation.CommandTypes]::Function)
