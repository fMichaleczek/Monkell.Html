    ...
    Html.Div {
        Metro.AppBar -Fixed Top <# -ColorScheme Navy #> {
            ...
            Html.Div -Class 'container' {
                ...
                Metro.AppBarElement -IsBranding -TextContent "My Company" -Prepend {
                ...
                Metro.AppBarMenu  {
                    Metro.AppBarMenuItem { Html.A -Href '#' Home -Prepend { Metro.Icon -Icon bug }  }
                    Metro.AppBarMenuItem { 
                        Html.A -Href '#' Pages  -Class 'dropdown-toggle' 
                        Metro.DMenuList -Data @{role="dropdown"} {
                            Metro.DMenuListItem { Html.A -Href '#' 'Powershell 2.0' -Prepend { Metro.Icon -Icon air -Class 'icon' } }
