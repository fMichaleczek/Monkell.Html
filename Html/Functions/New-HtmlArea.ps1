function New-HtmlArea {
   ...
   begin {
    ...
    if ("HtmlHost" -in $PSBoundParametersKeys) { $null = $PSBoundParameters.Add("Host",$HtmlHost) ; $null = $PSBoundParameters.Remove("HtmlHost")  }
   ...
   process {
    # Create HtmlElement
    $HtmlElement = $script:HtmlDocument.CreateElement('area')
